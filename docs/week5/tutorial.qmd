...
#| eval: false
#| code-fold: false
install.packages(c("MASS", "ggbeeswarm", "patchwork", "nullabor", "lvplot"))
```
...
#| fig-width: 8
#| fig-height: 6
d <- read_csv("https://raw.githubusercontent.com/numbats/ddde/main/docs/data/which-transform.csv")
