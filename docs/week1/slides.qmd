...
- Exercises 1 (**25%**), through GitHub classroom,  Due: Aug 21, 11:55pm. This is an individual assessment. 
<br>
...
Before we look any further at the tips data, write down:

- Three questions you would want to answer with this data
...
Before the next slide, sketch what you expect the histogram of `tip` to look like with a much narrower binwidth (e.g. 10 cent bins).
...
## Activity: Design a null sample {.activity-slide .center}

::: {style="font-size: 70%;"}
⏱ 8 minutes, in small groups
:::

Pick one claim: *"Smokers are less reliable tippers."*

- Describe a permutation or resampling scheme that could test whether this pattern is more extreme than you'd expect by chance
- What statistic would you compute from each null sample?
...
## Activity: Apply the guide to a new dataset {.activity-slide .center}

::: {style="font-size: 70%;"}
⏱ 10 minutes
:::

Choose a dataset you know well (or one provided by your tutor). Work through steps 1-4 of the Guide:

- Describe the variables and how the data was collected
- Brainstorm two questions and write down your expectations
- Sketch the plots/summaries you'd need to compute
