...
subtitle: "Using exploratory data analysis to assess a new data package"
author: "Prof. Di Cook"
...
### 1. What's in the data? (This is a check your knowledge and skills exercise)
...
Think about potential plots you might make for examining differences by geographic region (as measured by zip, county or city). Make a plot, and report what you learn. (Try making a letter value plot instead of the boxplots.)
