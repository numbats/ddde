...
[`fivenum()` returns min, lower hinge, median, upper hinge, max -- using the same depth rule you just used by hand.]{.smaller}
...
2. What changes as `k` gets smaller? As it gets larger?
